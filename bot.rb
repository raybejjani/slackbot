...
bot.on_message do |message, info|
  ...
  unless ['animatedgifs', 'askanything', 'aww', 'bot-testing', 'coffee', 'data', 'data-infra', 'kids-n-pets', 'open', 'product', 'random', 'recruiting', 'support', 'webcomix', 'yakshack'].include?(channel)
    next
  end  
